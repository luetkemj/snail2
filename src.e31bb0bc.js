...
exports.SET_TILES = exports.SET_CURRENT_MAP = exports.ADD_MAP = exports.PLACE_ENTITY = exports.MOVE_ENTITY = void 0;
var MOVE_ENTITY = "MOVE_ENTITY";
exports.MOVE_ENTITY = MOVE_ENTITY;
var PLACE_ENTITY = "PLACE_ENTITY";
exports.PLACE_ENTITY = PLACE_ENTITY;
var ADD_MAP = "ADD_MAP";
exports.ADD_MAP = ADD_MAP;
var SET_CURRENT_MAP = "SET_CURRENT_MAP";
exports.SET_CURRENT_MAP = SET_CURRENT_MAP;
var SET_TILES = "SET_TILES";
exports.SET_TILES = SET_TILES;
...
function _default() {
  ...
  switch (action.type) {
    case _actionTypes.PLACE_ENTITY:
      {
    ...
    case _actionTypes.MOVE_ENTITY:
      {
        ...
        var _entity = _objectSpread({}, state[_id], {
          x: _x,
          y: _y
        });

        return _objectSpread({}, state, _defineProperty({}, _id, _entity));
      }
...
},{"../action-types":"store/action-types.js","../../constants":"constants.js"}],"store/reducers/maps.reducer.js":[function(require,module,exports) {
"use strict";
    ...
    case _actionTypes.ADD_MAP:
      {
        ...
        return {
          ...
          maps: _objectSpread({}, state.maps, _defineProperty({}, id, map))
        };
      }

    case _actionTypes.SET_CURRENT_MAP:
      {
...
},{"../action-types":"store/action-types.js"}],"store/reducers/tiles.reducer.js":[function(require,module,exports) {
"use strict";
...
},{"../action-types":"store/action-types.js"}],"store/reducers/index.js":[function(require,module,exports) {
"use strict";
...
var _maps = _interopRequireDefault(require("./maps.reducer"));

var _tiles = _interopRequireDefault(require("./tiles.reducer"));
...
exports.default = _default;
},{"redux":"../node_modules/redux/es/redux.js","./entities.reducer":"store/reducers/entities.reducer.js","./maps.reducer":"store/reducers/maps.reducer.js","./tiles.reducer":"store/reducers/tiles.reducer.js"}],"store/index.js":[function(require,module,exports) {
"use strict";
...
var _default = store;
exports.default = _default;
},{"redux-starter-kit":"../node_modules/redux-starter-kit/dist/redux-starter-kit.esm.js","./reducers":"store/reducers/index.js"}],"lib/movement.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.canMoveTo = void 0;

var canMoveTo = function canMoveTo(x, y, state) {
  var tiles = state.tiles.tiles;

  if (tiles["".concat(x, ",").concat(y)].blocking) {
    return false;
  }
...
},{}],"store/actions/entity.actions.js":[function(require,module,exports) {
"use strict";
...
var _movement = require("../../lib/movement");

function moveEntity(_ref) {
  var id = _ref.id,
      x = _ref.x,
      y = _ref.y;
  return function (dispatch, getState) {
    ...
    if ((0, _movement.canMoveTo)(x, y, state)) {
      return dispatch({
...
function placeEntity(_ref2) {
  var id = _ref2.id,
      x = _ref2.x,
      y = _ref2.y;
  return {
    type: _actionTypes.PLACE_ENTITY,
    payload: {
      id: id,
      x: x,
      y: y
...
},{"../action-types":"store/action-types.js","../../lib/movement":"lib/movement.js"}],"../node_modules/rung/src/random.js":[function(require,module,exports) {
"use strict";
...
var _default = Random;
exports.default = _default;
},{}],"../node_modules/rung/src/algorithms/murmix.js":[function(require,module,exports) {
"use strict";
...
function murmix(key, seeds = 1) {
  ...
  for (let i = 0; i < key.length; i++) {
    h = Math.imul(h ^ key.charCodeAt(i), 3432918353), h = h << 13 | h >>> 19;
  }
...
var _default = murmix;
exports.default = _default;
},{}],"../node_modules/rung/src/seed.js":[function(require,module,exports) {
"use strict";
...
var _murmix = _interopRequireDefault(require("./algorithms/murmix"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function seed(key = new Date().toString(), seeds = 1) {
  const result = (0, _murmix.default)(key, seeds);
  return seeds == 1 ? result[0] : result;
}

var _default = seed;
exports.default = _default;
},{"./algorithms/murmix":"../node_modules/rung/src/algorithms/murmix.js"}],"../node_modules/rung/src/algorithms/mersenne-twister.js":[function(require,module,exports) {
"use strict";
...
var _default = mersenneTwister;
exports.default = _default;
},{}],"../node_modules/rung/src/rung.js":[function(require,module,exports) {
"use strict";
...
var _mersenneTwister = _interopRequireDefault(require("./algorithms/mersenne-twister"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function rung(seed = Date.now()) {
  return new _random.default((0, _mersenneTwister.default)(seed));
}

rung.Random = _random.default;
rung.seed = _seed.default;
var _default = rung;
exports.default = _default;
},{"./random":"../node_modules/rung/src/random.js","./seed":"../node_modules/rung/src/seed.js","./algorithms/mersenne-twister":"../node_modules/rung/src/algorithms/mersenne-twister.js"}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../node_modules/lodash/lodash.js":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"lib/grid.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rectsIntersect = exports.rectangle = void 0;
...
var rectangle = function rectangle(_ref, tileProps) {
  var x = _ref.x,
      y = _ref.y,
      width = _ref.width,
      height = _ref.height,
      hasWalls = _ref.hasWalls;
  var tiles = {};
  var x1 = x;
  var x2 = x + width;
  var y1 = y;
  ...
  if (hasWalls) {
    for (var yi = y1 + 1; yi < y2 - 1; yi++) {
      for (var xi = x1 + 1; xi < x2 - 1; xi++) {
        tiles["".concat(xi, ",").concat(yi)] = _objectSpread({
          x: xi,
          y: yi
        }, tileProps);
      }
    ...
    for (var _yi = y1; _yi < y2; _yi++) {
      for (var _xi = x1; _xi < x2; _xi++) {
        tiles["".concat(_xi, ",").concat(_yi)] = _objectSpread({
          x: _xi,
          y: _yi
        }, tileProps);
      }
...
var _rung = _interopRequireDefault(require("rung/src/rung"));
...
function digHorizontalPassage(tiles, x1, x2, y) {
  ...
  var end = Math.max(x1, x2) + 1;
  var x = start;

  while (x < end) {
    tiles["".concat(x, ",").concat(y)] = {
      x: x,
      y: y,
      sprite: "FLOOR"
    };
...
var generateDungeon = function generateDungeon(_ref) {
  var x = _ref.x,
      y = _ref.y,
      width = _ref.width,
      height = _ref.height,
      maxRoomCount = _ref.maxRoomCount,
      minRoomSize = _ref.minRoomSize,
      maxRoomSize = _ref.maxRoomSize;

  // fill the entire space with walls so we can dig it out later
  var _rectangle = (0, _grid.rectangle)({
    x: x,
    y: y,
    width: width,
    height: height
    ...
    blocking: true
      ...
      tiles = _rectangle.tiles;

  var rng = (0, _rung.default)();
  var rooms = [];
  var roomTiles = {};
  ...
  try {
    var _loop = function _loop() {
      var r = _step.value;
      var rw = rng.integer(minRoomSize, maxRoomSize);
      var rh = rng.integer(minRoomSize, maxRoomSize);
      var rx = rng.integer(1, width - rw - 1);
      var ry = rng.integer(1, height - rh - 1); // create a candidate room
      // todo: perf - don't bother filling this in here - wait till it's accepted

      var candidate = (0, _grid.rectangle)({
        x: rx,
        y: ry,
        width: rw,
        height: rh,
      ...
      if (!rooms.some(function (room) {
        return (0, _grid.rectsIntersect)(room, candidate);
      })) {
        rooms[r] = candidate;
        roomTiles = _objectSpread({}, roomTiles, {}, candidate.tiles);
      }
    };

    for (var _iterator = Array(maxRoomCount).keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      _loop();
    }
  } catch (err) {
  ...
  try {
    for (var _iterator2 = (0, _lodash.compact)(rooms)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var room = _step2.value;

      if (prevRoom) {
        var prev = prevRoom.center;
        var curr = room.center;
  ...
  return {
    tiles: _objectSpread({}, tiles, {}, roomTiles),
    start: rooms[0].center
  };
};

exports.generateDungeon = generateDungeon;
},{"rung/src/rung":"../node_modules/rung/src/rung.js","lodash":"../node_modules/lodash/lodash.js","./grid":"lib/grid.js"}],"../node_modules/overprint/overprint/char.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./char":"../node_modules/overprint/overprint/char.js","./font":"../node_modules/overprint/overprint/font.js","./glyph":"../node_modules/overprint/overprint/glyph.js","./cell":"../node_modules/overprint/overprint/cell.js","./display-state":"../node_modules/overprint/overprint/display-state.js"}],"sprites.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  PLAYER: (0, _cell.default)("@", "#DAA520"),
  WALL: (0, _cell.default)("#", "#AAA"),
  FLOOR: (0, _cell.default)("•", "#AAA")
};
exports.default = _default;
},{"overprint/overprint/cell":"../node_modules/overprint/overprint/cell.js"}],"screen.js":[function(require,module,exports) {
"use strict";
...
var canvas = document.querySelector("#game"); // Create a default text grid from the canvas element
...
var renderScreen = function renderScreen() {
  ...
  var _store$getState$tiles = _store.default.getState().tiles,
      tiles = _store$getState$tiles.tiles,
      tileIds = _store$getState$tiles.ids; // write tiles


  tileIds.forEach(function (id) {
    return grid.writeCell(tiles[id].x, tiles[id].y, _sprites.default[tiles[id].sprite]);
  }); // write player

  grid.writeCell(player.x, player.y, _sprites.default[player.sprite]); // Re-render the cells that changed since the previous render

  grid.render();
};

exports.renderScreen = renderScreen;
},{"overprint/overprint/text-grid":"../node_modules/overprint/overprint/text-grid.js","overprint/overprint/font":"../node_modules/overprint/overprint/font.js","./sprites":"sprites.js","./constants":"constants.js","./store":"store/index.js"}],"store/actions/maps.actions.js":[function(require,module,exports) {
"use strict";
...
exports.setCurrentMap = setCurrentMap;
...
function setCurrentMap(_ref2) {
  var id = _ref2.id;
  1;
  return {
    type: _actionTypes.SET_CURRENT_MAP,
    payload: {
      id: id
    }
  };
}
},{"../action-types":"store/action-types.js"}],"store/actions/tiles.actions.js":[function(require,module,exports) {
"use strict";
...
function setTiles(_ref) {
  var tiles = _ref.tiles;
  return {
    type: _actionTypes.SET_TILES,
    payload: {
      tiles: tiles
    }
  };
}
},{"../action-types":"store/action-types.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _maps = require("./store/actions/maps.actions");

var _tiles = require("./store/actions/tiles.actions");
...
// generate map
var dungeon = (0, _dungeon.generateDungeon)({
  x: 0,
  y: 0,
  width: _constants.WIDTH,
  height: _constants.HEIGHT,
...
_store.default.dispatch((0, _maps.addMap)({
  map: dungeon,
  id: 0
})); // set current map


_store.default.dispatch((0, _maps.setCurrentMap)({
  id: 0
})); // set tiles for rendering on screen


_store.default.dispatch((0, _tiles.setTiles)({
  tiles: dungeon.tiles
})); // get center of a random room in dungeon


var currentMapId = _store.default.getState().maps.current;

var startingLoc = _store.default.getState().maps.maps[currentMapId].start; // place player


_store.default.dispatch((0, _entity.placeEntity)(_objectSpread({
  id: 0
}, startingLoc)));
...
function handleAction(action) {
  ...
  var mx = Math.min(_constants.WIDTH - 1, Math.max(0, player.x + action.x));
  var my = Math.min(_constants.HEIGHT - 1, Math.max(0, player.y + action.y));
  var payload = {
    id: 0,
    x: mx,
    y: my
...
function gameLoop() {
  update();
  (0, _screen.renderScreen)(_constants.WIDTH, _constants.HEIGHT);
  requestAnimationFrame(gameLoop);
}

requestAnimationFrame(gameLoop);
},{"./store":"store/index.js","./store/actions/entity.actions":"store/actions/entity.actions.js","./lib/dungeon":"lib/dungeon.js","./constants":"constants.js","./screen":"screen.js","./store/actions/maps.actions":"store/actions/maps.actions.js","./store/actions/tiles.actions":"store/actions/tiles.actions.js"}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
